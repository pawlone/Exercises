...
const useCategory = (params = { id: 0, includeGames: false }) => {
...
const useDelete = (url = "", id = 0) => {
    ...
    return (successFunction) => {
        axios.delete(deleteUrl += "?id=" + id).then(result => {
            if (result.data) {
                successFunction();
            }
        });
...
export { useGet, useGames, useCategory, useSubmit, useDelete, GAMES_URL, CATEGORY_URL };